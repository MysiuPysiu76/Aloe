...
class MultiFileBoxContextMenu extends ExtendedContextMenu {
    public MultiFileBoxContextMenu(List<File> files) {
        ...
        ExtendedMenuItem moveToTrash = new ExtendedMenuItem("context-menu.move-to-trash", e -> new FileMoveTask(files, new File(System.getProperty("user.home"), ".trash"), true));
